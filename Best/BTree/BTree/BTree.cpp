...
int main()
{
	...
	while (choice != 8) {
		...
		cout << "              1.Output A Linked List Binary Tree                     " << endl;
		cout << "              2.Search A Letter(return many groups with three atoms)                     " << endl;
		cout << "              3.Locate A Letter(return a letter)                     " << endl;
		cout << "              4.Search A Word(return counts of groups and one of solution)                     " << endl;
		cout << "              5.Insert A Letter(input: a, b, x;  to insert a letter)                     " << endl;
		cout << "              6.Delete A Letter(input: a, b, x;  to delete a letter)                     " << endl;
		cout << "              7.Duplicate Removal(delete same element under a tree node)               " << endl;
...
int menu()
{
	int choice;
	cout << "***********************    Linked List Binary Tree System Menu ***********************" << endl;
	cout << "              1.Create A Linked List Binary Tree                     " << endl;
	cout << "              2.Search A Letter(return a group with three atoms)                     " << endl;
	cout << "              3.Locate A Letter(return a letter)                     " << endl;
	cout << "              4.Search A Word(return counts of groups and one of solution)                     " << endl;
	cout << "              5.Insert A Letter(input: a, b, x;  to insert a letter)                     " << endl;
	cout << "              6.Delete A Letter(input: a, b, x;  to delete a letter)                     " << endl;
		...
		else
		{
			...
			if (T->layer == inputLayer && T->order == inputOrderOfLayer)
			{
				...
				while (currentPoint)
				{
					...
					{
						flag = 2;
						cout << "Successed! The value (" << inputLayer << ", " << inputOrderOfLayer << ", " << inputOrderOfList << ") has been find! Result as follows: " << endl;
						cout << "value: " << currentPoint->val << "\tlayer: " << T->layer << "\torder(layer): " << T->order << "\t\torder(list): " << number << endl;
					}
					currentPoint = currentPoint->next;
				}
			}
	...
	while (1)
	{
		...
		if (T == NULL)
		{
			...
			if (SolutionCount != 0)
			{
				...
				for (int i = 0; i < inputWord.size(); i++)
				{
					cout << "letter: " << inputWord.at(i) << "\tlayer: " << wordSolution[i][1] << "\torder(layer): " << wordSolution[i][2] << "\t\torder(list): " << wordSolution[i][3] << endl;
				}
			}
			else
			{
				cout << "Exist letter(s) can't find in this tree! Please input again! " << endl;
			}
			return;
		}
		else
